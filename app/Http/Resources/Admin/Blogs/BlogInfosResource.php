...
class BlogInfosResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'title_1_ru'        =>  $this->translate('ru')->title_1,
            'title_2_uz'        =>  $this->translate('uz')->title_2,
            ...
            'description_3_uz'  =>  $this->translate('uz')->description_3,
            'description_3_ru'  =>  $this->translate('ru')->description_3,
            'description_4_uz'  =>  $this->translate('uz')->description_4,
