                                ...
                                <div class="col-sm-6 col-md-8 col-lg-8">
                                    <div id="uz-form" >
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <textarea name="uz[description]" class="form-control" cols="30" rows="10"> {{ old('uz.description') }} </textarea>
                                    ...
                                    <div id="ru-form" class="d-none">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <textarea name="ru[description]" class="form-control" cols="30" rows="10"> {{ old('ru.description') }} </textarea>
