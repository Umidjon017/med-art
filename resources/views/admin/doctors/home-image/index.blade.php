                  ...
                  <tbody>
                    ...
                    <tr class="odd">
                        ...
                        <td class="d-flex justify-content-center">
                            <a href="{{ route('admin.doctors.home-image.edit', $item->id) }}" class="btn btn-warning">
                                <i class="fas fa-edit"></i>
                            </a>
                            {{-- @can('home-delete') --}}
                            <form action="{{route('admin.doctors.home-image.destroy', $item->id)}}" method="POST">
                                @csrf
                                @method('DELETE')
                   ...
                   @include('admin.doctors.home-image.create')
                  </tbody>
                </table>
              </div>
            </div>
