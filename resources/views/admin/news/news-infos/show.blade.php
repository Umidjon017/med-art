                        ...
                        <div class="row mb-2">
                            <div class="card-header col-sm-6">
                                ...
                                <div class=" d-flex justify-content-center">
                                    <a href="{{ route('admin.news.news-infos.index') }}"><button class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Ortga</button></a>
                                    {{-- @can('news-edit') --}}
                                        <a href="{{ route('admin.news.news-infos.edit', $item->id) }}"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square" aria-hidden="true"></i> Tahrirlash</button></a>
                                    {{-- @endcan --}}
                                    {{-- @can('news-delete') --}}
                                    ...
                                    <div class=" d-flex justify-content-between">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active">
                                                <h6> {!! $item->popularity == 1 ? 'Ha' : 'Yo`q' !!} </h6>
                                            </div>
                                        </div>
                                    </div> <hr>
                                </div>
