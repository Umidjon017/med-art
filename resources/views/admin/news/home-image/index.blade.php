                  ...
                  <tbody>
                    ...
                    <tr class="odd">
                        ...
                        <td class="d-flex justify-content-center">
                            <a href="{{ route('admin.news.home-image.edit', $item->id) }}" class="btn btn-warning">
                                <i class="fas fa-edit"></i>
                            </a>
                            {{-- @can('home-delete') --}}
                            <form action="{{route('admin.news.home-image.destroy', $item->id)}}" method="POST">
                                @csrf
                                @method('DELETE')
                   ...
                   @include('admin.news.home-image.create')
                  </tbody>
                </table>
              </div>
            </div>
