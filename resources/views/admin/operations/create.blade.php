                        ...
                        <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="uz[detail_description]" class="summernote-simple"> {{ old('uz.detail_description') }} </textarea>
                                            ...
                                            <div class="col-sm-12 col-md-6 col-lg-6">
                                                <div class="form-group ">
                                                    ...
                                                    <textarea name="uz[full_description]" class="summernote-simple"> {{ old('uz.full_description') }} </textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 com-md-6 col-lg-6">
                                                <div class="form-group ">
                                                    ...
                                                    <textarea name="ru[detail_description]" class="summernote-simple"> {{ old('ru.detail_description') }} </textarea>
                                            ...
                                            <div class="col-sm-12 com-md-6 col-lg-6">
                                                <div class="form-group ">
                                                    ...
                                                    <textarea name="ru[full_description]" class="summernote-simple"> {{ old('ru.full_description') }} </textarea>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group ">
                                        <label>Sana</label>
                                        <input type="date" name="date" class="form-control" placeholder="Sanani kiriting" value="{{ old('date') }}">
                                        @error('date')
                                            <div class="alert alert-danger">
                                                {{ $message }}
                                            </div>
