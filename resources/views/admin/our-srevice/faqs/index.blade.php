                ...
                <table class="table table-striped" id="table-1">
                  ...
                  <tbody>
                    ...
                    <tr class="odd">
                        ...
                        <td>{!! $faq->translateOrNew('uz')->question !!}</td>
                        <td>{!! $faq->translateOrNew('uz')->answer !!}</td>
                        <td class="d-flex justify-content-center">
                            <a href="{{ route('admin.our-service.faqs.edit', $faq->id) }}" class="btn btn-warning">
                                <i class="fas fa-edit"></i>
                            </a>
                            {{-- @can('home-delete') --}}
                            <form action="{{route('admin.our-service.faqs.destroy', $faq->id)}}" method="POST">
                                @csrf
                                @method('DELETE')
                   ...
                   @include('admin.our-srevice.faqs.create')
                  </tbody>
                </table>
              </div>
            </div>
